...
if(CLIENT)then
	...
	local function DoCigarette()
		...
		if( pl:GetNetworkedFloat("durgz_cigarette_high_start") && pl:GetNetworkedFloat("durgz_cigarette_high_end") > CurTime() )then
			...
			if( pl:GetNetworkedFloat("durgz_cigarette_high_start") + TRANSITION_TIME > CurTime() )then
			
				local s = pl:GetNetworkedFloat("durgz_cigarette_high_start");
				local e = s + TRANSITION_TIME;
				local c = CurTime();
				pf = (c-s) / (e-s);
			elseif( pl:GetNetworkedFloat("durgz_cigarette_high_end") - TRANSITION_TIME < CurTime() )then
			
				local e = pl:GetNetworkedFloat("durgz_cigarette_high_end");
